...
- **성인·유소년 통합/분리** — 수강별로 성인·유소년을 하나의 요금으로 **통합**하거나 각각 **분리**해서 설정
...
- **Unified or split adult/youth** — each lesson can share one price for adult & youth (**unified**) or set them **separately**
